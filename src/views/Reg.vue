<template>
	<div class="Reg">
		...
		<van-field v-model="pVal" type="password" placeholder="请输入密码" clearable left-icon="thumb-circle-o" />
		<div class="File-Box">
		...
		<div id="btn_down">
			<van-checkbox v-model="checked" label-disabled icon-size="14px">我已阅读并同意<a href="">《用户服务协议》</a></van-checkbox>
